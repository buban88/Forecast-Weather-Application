...
public class WeatherForecastService {
    ...
    public WeatherForecastService(OpenWeatherApiCaller openWeatherApiCaller,PopulateMinMaxTemperature populateMinMaxTemperature, WeatherForecastResponseBuilder weatherForecastResponseBuilder, RequestParameterValidator requestParameterValidator) {
    ...
    public WeatherForecastResponse getTemperature(String transactionId, String cityName, String metricUnit) {
